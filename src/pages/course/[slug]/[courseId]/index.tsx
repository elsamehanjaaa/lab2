// pages/courses/[courseId]/index.tsx
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white shadow p-6 rounded-md">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <li>Build fullstack apps with SSR</li>
                <li>Work with APIs and authentication</li>
                <li>Deploy using Vercel or other providers</li>
              </ul>
            </div>
