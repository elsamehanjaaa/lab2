    ...
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-32 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-xl font-semibold md:text-xl mb-8">
              At <span className="text-blue-950 font-extrabold">EduSpark,</span> we believe that education is the spark that ignites change.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <p className="text-lg text-center mb-12 max-w-3xl mx-auto">
          ...
          As a leader in online learning, <span className="text-blue-950 font-bold">EduSpark</span> is your partner in unlocking new opportunities,
          achieving your goals, and transforming your future.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-black text-base leading-relaxed">
              Change is constant — but growth is a choice. At <span className="text-blue-950 font-bold">EduSpark</span>,
              we don’t just help you keep up with change — we help you lead it.
              Our learning experiences are designed to prepare you for the challenges ahead,
              equipping you with the tools to thrive in an ever-evolving world.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-[#a7b3ff] to-[#cfcaff] text-[#1f1f1f] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl mb-12 max-w-3xl mx-auto">
            We’re more than just a learning platform — we're a global movement shaping the future of education.
          </p>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 text-center">
            <div>
              <p className="text-3xl font-extrabold">77K+</p>
              <p className="text-blue-600 hover:text-blue-950 font-semibold mt-2 text-sm">Learners transforming their futures</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold">80K+</p>
              <p className="text-blue-600 hover:text-blue-950 font-semibold mt-2 text-sm">Expert instructors driving innovation</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold">250K+</p>
              <p className="text-blue-600 hover:text-blue-950 font-semibold mt-2 text-sm">Courses across every major field</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold">1M+</p>
              <p className="text-blue-600 hover:text-blue-950 font-semibold mt-2 text-sm">Course enrollments and counting</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold">75+</p>
              <p className="text-blue-600 hover:text-blue-950 font-semibold mt-2 text-sm">Languages breaking down barriers</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold">17K+</p>
              <p className="text-blue-600 hover:text-blue-950 font-semibold mt-2 text-sm">Enterprise customers building stronger teams</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white py-20 px-6 text-center">
        <div className="max-w-4xl mx-auto mb-12">
          <p className="text-base md:text-lg text-gray-800 leading-relaxed">
            We partner with organizations of every size and sector to help them stay ahead of what's next.
            By delivering expertly curated courses in business, technology, and beyond, we empower companies,
            institutions, and nonprofits to grow, adapt, and lead—placing learning at the core of their success.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto text-left">
          {[
            {
              quote: "EduSpark’s courses fit us perfectly. Their team consistently delivers fresh, up-to-date content that’s easy to implement and perfectly aligned with our development goals.",
              name: "Varun Patil",
            ...
            {
              quote: "Overall, it was a major success. I regularly received feedback from our teams on how impactful and practical the EduSpark platform was.",
            ...
            {
              quote: "EduSpark adapted quickly to our evolving business needs and delivered real results globally. It’s by far the best solution we’ve found for upskilling our employees.",
            ...
            <div key={i}>
              ...
              <p className="text-base md:text-lg text-gray-900 mb-6">{item.quote}</p>
              <div>
                <p className="font-bold">{item.name}</p>
                <p className="text-sm text-gray-600">{item.title}</p>
                <a href={item.link} className="text-[#4f46e5] font-semibold mt-2 inline-block">
                  {item.linkText}
                </a>
              </div>
            </div>
