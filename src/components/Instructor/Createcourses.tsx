    ...
    <div className="max-w-5xl mx-auto p-8 lg:p-12 bg-gray-900 text-white shadow-xl rounded-3xl mt-6 flex flex-col h-[85vh]">
      <div className="flex-shrink-0">
        <div className="flex items-center mb-4 pb-4 border-b border-gray-700">
          ...
          <h1 className="text-4xl font-extrabold text-white flex items-center">
            ...
            <span className="text-lg ml-2 font-medium text-blue-400">
              Step {step} of 3
            </span>
          </h1>
        </div>
      ...
      >
        <div className="flex-grow overflow-y-auto">
          {step === 1 && (
            <div className="p-1 animate-fade-in">
              <h2 className="text-2xl font-bold text-blue-400 mb-6 flex items-center">
                <div className=" text-white w-8 h-8 flex items-center justify-center mr-3">
                  1
                </div>
                Course Information
              </h2>
              ...
              <div className="mt-6 space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  required
                  placeholder="Provide a compelling short description..."
                  className="w-full bg-gray-700 text-white border-gray-800 hover:bg-gray-800 border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                />
              </div>
              <div className="mt-6">
          ...
          {step === 2 && (
            <div className="p-1 animate-fade-in overflow-x-hidden">
              <h2 className="text-2xl font-bold text-blue-400 mb-6 flex items-center ">
                <div className=" text-white w-8 h-8  flex items-center justify-center mr-3">
                  2
                </div>
              ...
              <div className="mb-6">
                <label
                  ...
                  className="w-full flex flex-col items-center justify-center px-4 py-6 bg-gray-700 text-white rounded-lg shadow-md tracking-wide uppercase border border-gray-800 cursor-pointer hover:bg-gray-800 transition-colors group"
                >
                  <svg
                  ...
                  <p className="text-xs text-gray-400 group-hover:text-white mt-1">
              ...
              {sections.length === 0 && !loading && (
                <div className="text-center py-12 bg-gray-800 rounded-xl border-2 border-dashed border-gray-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-gray-500 mt-4">
                    Upload a folder or add sections manually.
                  </p>
                </div>
              )}
              ...
              {sections.map((section, index) => (
                <div
                  key={section.id}
                  className="relative group bg-gray-800 p-1 mb-3 rounded-xl transition-all"
                >
                  <div className="absolute top-1/2 -right-12 -translate-y-1/2 z-10 flex flex-col space-y-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-150">
                    <button
                      type="button"
                      onClick={() => handleMoveSection(section.id, "up")}
                      disabled={index === 0}
                      className="p-2 bg-gray-600 hover:bg-gray-500 text-white rounded-full shadow-md disabled:opacity-40 disabled:cursor-not-allowed transition-all"
